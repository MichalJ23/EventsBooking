...
if (isset($_SESSION['id']) && isset($_SESSION['login']) && $_SESSION['isAdmin'] == 1) {
    if (isset($_POST["submit"])) {
        ...
        $sql = "UPDATE `users` SET `login`='$login', `password`='$password', `name`='$name', `isAdmin`='$isAdmin' WHERE id = " . $_GET['edit_id'];
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Edytuj dane i kliknij przycisk "Zapisz"</p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div class="form-check mb-3">
                    <input type="checkbox" class="form-check-input" name="isAdmin" id="isAdmin" <?php echo ($row['isAdmin'] == 1) ? 'checked' : ''; ?>>
